...
namespace filler
{
        ...
        // animation fillCustomBFS(PNG &img, int x, int y, int counter, double tolerance, int frameFreq);
        
        // animation fillCustomDFS(PNG &img, int x, int y, int counter, double tolerance, int frameFreq);
        /**
    ...
    void fillSurroundingPixels(PNG& img, double tol, int xCoord, int yCoord, colorPicker &fillColor, 
                               int frameFreq, animation &anim, HSLAPixel centerColor, 
                               vector<vector<bool>> &visited, int &frame_counter, 
